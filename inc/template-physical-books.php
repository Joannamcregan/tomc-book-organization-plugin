...
?><main class="full-screen">
    <div class="banner"><h1 class="centered-text banner-heading-46">Physical Books By Our Authors</h1></div>
    <div>
        <?php if ($results) {
        ...
        <?php } else {
            ?><p class="centered-text padded-paragraph-20-x">No physical books have been added yet. Check back soon!</p>
        <?php } ?>
    </div>
</main>
