    ...
    <?php if (is_user_logged_in()){
        if (in_array( 'dc_vendor', (array) $user->roles ) ){
            ...
            <div id="tomc-book-organization--new-book-forms-section">
                <div class="tomc-book-organization--form" id="tomc-book-organization--add-book" >
                    ...
                    <div class="tomc-book-organization--form-div">
                        <label for="tomc-book-organization--excerpt">Enter a short excerpt from your book (up to 10,000 characters).</label><br>
                ...
                <div class="tomc-book-organization--form opacity-30" aria-disabled="true" id="tomc-book-organization--readalikes" >
                    <h3>Add one or two books you feel are similar to yours.</h3>
                    <p class="centered-text">(This is optional, but can help readers find your book.)</p>
                    <div class="tomc-book-organization--form-div">
            ...
            <div class="tomc-book-organization__overlay" id="tomc-book-organization__genre-overlay">
                <div class="overlay-main-container"> 
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="30" viewBox="0 0 30 30" class="tomc-book-organization__overlay__close" id="tomc-book-organization__genre-overlay-close">
        ...
        <?php } else {
            ?><div class="half-screen">
                <p class="centered-text padding-x-20">Only authors can create books.</p>
