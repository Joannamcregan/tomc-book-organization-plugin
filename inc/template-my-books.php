            ...
            if ($books){
                ?><div class="third-screen">
                    ...
                    <?php foreach($books as $book){
                        ?><div class="tomc-book-organization--book-to-edit page-accent-alt-thin tomc-book-options--cursor-pointer">
                            ...
                            <div class="tomc-book-organization--edit-book-options hidden">
                                <p class="centered-text tomc-book-organization--blue-text tomc-book-organization--edit-basic-info tomc-book-options--cursor-pointer">basic info</p>
                                <p class="centered-text tomc-book-organization--blue-text tomc-book-organization--edit-languages tomc-book-options--cursor-pointer">languages</p>
                                <p class="centered-text tomc-book-organization--blue-text tomc-book-organization--edit-genres tomc-book-options--cursor-pointer">genres and subgenres</p>
                                <p class="centered-text tomc-book-organization--blue-text tomc-book-organization--edit-character-identities tomc-book-options--cursor-pointer">character identities</p>
                                <p class="centered-text tomc-book-organization--blue-text tomc-book-organization--edit-readalikes tomc-book-options--cursor-pointer">read-alikes</p>
                                <p class="centered-text tomc-book-organization--blue-text tomc-book-organization--edit-content-warnings tomc-book-options--cursor-pointer">content warnings</p>
                                <p class="centered-text tomc-book-organization--blue-text tomc-book-organization--edit-linked-products tomc-book-options--cursor-pointer">linked products</p>
                            </div>
                        </div>
                    <?php }
                    ...
                    ?><div class="tomc-book-organization__overlay" id="tomc-book-organization__edit-basic-info-overlay">
                        <div class="overlay-main-container"> 
                            ...
                            <div class="tomc-book-organization__edit-basic-info-container"></div>
                    ...
                    <div class="tomc-book-organization__overlay" id="tomc-book-organization__edit-languages-overlay">
                        <div class="overlay-main-container"> 
                            ...
                            <div class="tomc-book-organization__edit-languages-container"></div>
